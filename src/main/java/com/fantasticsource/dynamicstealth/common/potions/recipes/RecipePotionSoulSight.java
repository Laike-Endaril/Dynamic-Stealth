...
public class RecipePotionSoulSight extends BrewingRecipe
{
    ...
    private static final ItemStack DEFAULT_OUTPUT = PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), Potions.POTIONTYPE_SOULSIGHT);
    ...
    {
        if (isInput(input) && isIngredient(ingredient)) return PotionUtils.addPotionToItemStack(new ItemStack(input.getItem()), Potions.POTIONTYPE_SOULSIGHT);
