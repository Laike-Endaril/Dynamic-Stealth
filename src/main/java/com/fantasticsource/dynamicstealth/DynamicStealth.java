...
@Mod(modid = DynamicStealth.MODID, name = DynamicStealth.NAME, version = DynamicStealth.VERSION, dependencies = "required-after:fantasticlib@[1.12.2.047l,)")
public class DynamicStealth
{
    ...
    public static final String VERSION = "1.12.2.115";
    ...
    {
        if (DynamicStealthConfig.clientSettings.hudSettings.stealthGaugeStyle.stealthGaugeMode != 3)
        {
                            ...
                            switch (type)
                            {
                                ...
                                case 2:
                                    ...
                                    if (target == null || !feelerLiving.senses.canSee(target))
                                    {
                                        ...
                                        else makeLivingLookTowardEntity(feelerLiving, felt);
                                    }
                                    break;
                            }
                        }
    ...
    {
        Entity entity = event.getEntity();
        if (entity instanceof EntityLiving && !GlobalDefaultsAndData.isFullBypass(entity))
        {
