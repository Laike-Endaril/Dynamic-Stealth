...
public class AttackDefaults
{
    ...
    static
    {
        ...
        stealthAttackDefaults.add("backstab:diamond_dagger, true, 3");
        stealthAttackDefaults.add("backstab:gold_dagger, true, 3");
        stealthAttackDefaults.add("natura:ghostwood_kama, true, 2");
        stealthAttackDefaults.add("natura:bloodwood_kama, true, 2");
        stealthAttackDefaults.add("natura:darkwood_kama, true, 2");
        stealthAttackDefaults.add("natura:fusewood_kama, true, 2");
