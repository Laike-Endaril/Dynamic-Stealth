...
public class AttackDefaults
{
    public static ArrayList<String>
            normalAttackDefaults = new ArrayList<>(),
            stealthAttackDefaults = new ArrayList<>(),
            normalAttackBlockedDefaults = new ArrayList<>(),
            stealthAttackBlockedDefaults = new ArrayList<>(),
            assassinationDefaults = new ArrayList<>();
